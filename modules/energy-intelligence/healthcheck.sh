#!/usr/bin/env bash
# =============================================================================
# energy-intelligence/healthcheck.sh — Intelligence module health check
# -----------------------------------------------------------------------------
...
#
# Usage: modules/energy-intelligence/healthcheck.sh [--json] [--quiet]
# Exit: 0 healthy, 1 FAIL present, 2 usage error.
# =============================================================================
set -o errexit -o nounset -o pipefail

PRODUCT_ID="energy-intelligence"
