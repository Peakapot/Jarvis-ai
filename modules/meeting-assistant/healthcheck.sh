#!/usr/bin/env bash
# =============================================================================
# meeting-assistant/healthcheck.sh — Module health check
# -----------------------------------------------------------------------------
# Self-contained health check for the meeting-assistant module (Observability by default).
...
#
# Usage: modules/meeting-assistant/healthcheck.sh [--json] [--quiet]
# Exit codes: 0 healthy, 1 one or more FAIL, 2 usage error.
# =============================================================================
set -o errexit -o nounset -o pipefail

MODULE_ID="meeting-assistant"
ENABLE_VAR="MEETING_ASSISTANT_ENABLED"
