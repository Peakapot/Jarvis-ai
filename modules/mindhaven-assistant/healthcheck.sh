#!/usr/bin/env bash
# =============================================================================
# mindhaven-assistant/healthcheck.sh — Module health check
# -----------------------------------------------------------------------------
# Self-contained health check for the mindhaven-assistant module (Observability by default).
...
#
# Usage: modules/mindhaven-assistant/healthcheck.sh [--json] [--quiet]
# Exit codes: 0 healthy, 1 one or more FAIL, 2 usage error.
# =============================================================================
set -o errexit -o nounset -o pipefail

MODULE_ID="mindhaven-assistant"
ENABLE_VAR="MINDHAVEN_ASSISTANT_ENABLED"
