#!/usr/bin/env bash
# =============================================================================
# knowledge-assistant/healthcheck.sh — Module health check
# -----------------------------------------------------------------------------
# Self-contained health check for the knowledge-assistant module (Observability by default).
...
#
# Usage: modules/knowledge-assistant/healthcheck.sh [--json] [--quiet]
# Exit codes: 0 healthy, 1 one or more FAIL, 2 usage error.
# =============================================================================
set -o errexit -o nounset -o pipefail

MODULE_ID="knowledge-assistant"
ENABLE_VAR="KNOWLEDGE_ASSISTANT_ENABLED"
