#!/usr/bin/env bash
# =============================================================================
# dealforge-assistant/healthcheck.sh — Module health check
# -----------------------------------------------------------------------------
# Self-contained health check for the dealforge-assistant module (Observability by default).
...
#
# Usage: modules/dealforge-assistant/healthcheck.sh [--json] [--quiet]
# Exit codes: 0 healthy, 1 one or more FAIL, 2 usage error.
# =============================================================================
set -o errexit -o nounset -o pipefail

MODULE_ID="dealforge-assistant"
ENABLE_VAR="DEALFORGE_ASSISTANT_ENABLED"
